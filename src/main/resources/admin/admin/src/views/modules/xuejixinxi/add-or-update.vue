<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="现读学校" prop="xianduxuexiao">
          <el-input v-model="ruleForm.xianduxuexiao" 
              placeholder="现读学校" clearable  :readonly="ro.xianduxuexiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="现读学校" prop="xianduxuexiao">
              <el-input v-model="ruleForm.xianduxuexiao" 
                placeholder="现读学校" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="体检表" prop="tijianbiao">
          <file-upload
          tip="点击上传体检表"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.tijianbiao?ruleForm.tijianbiao:''"
          @change="tijianbiaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.tijianbiao" label="体检表" prop="tijianbiao">
            <el-button type="text" size="small" @click="download(ruleForm.tijianbiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="学生成绩表" prop="xueshengchengjibiao">
          <file-upload
          tip="点击上传学生成绩表"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xueshengchengjibiao?ruleForm.xueshengchengjibiao:''"
          @change="xueshengchengjibiaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengchengjibiao" label="学生成绩表" prop="xueshengchengjibiao">
            <el-button type="text" size="small" @click="download(ruleForm.xueshengchengjibiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党籍关系" prop="dangjiguanxi">
          <el-input v-model="ruleForm.dangjiguanxi" 
              placeholder="党籍关系" clearable  :readonly="ro.dangjiguanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党籍关系" prop="dangjiguanxi">
              <el-input v-model="ruleForm.dangjiguanxi" 
                placeholder="党籍关系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.rongyuzhengshu" label="荣誉证书" prop="rongyuzhengshu">
          <file-upload
          tip="点击上传荣誉证书"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.rongyuzhengshu?ruleForm.rongyuzhengshu:''"
          @change="rongyuzhengshuUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.rongyuzhengshu" label="荣誉证书" prop="rongyuzhengshu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.rongyuzhengshu.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  data() {
	...
	zuigaoxueli : false,
	tijianbiao : false,
	xueshengchengjibiao : false,
	dangjiguanxi : false,
	rongyuzhengshu : false,
	zhaopian : false,
      },
      ruleForm: {
        xuehao: '',
      ...
      rules: {
          ...
          xianduxuexiao: [
                { required: true, message: '现读学校不能为空', trigger: 'blur' },
          ],
          zuigaoxueli: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzhenghao = true;
          ...
          if(o=='xianduxuexiao'){
            this.ruleForm.xianduxuexiao = obj[o];
	    this.ro.xianduxuexiao = true;
            continue;
          }
          if(o=='zuigaoxueli'){
	    ...
	    this.ro.zuigaoxueli = true;
          ...
          if(o=='tijianbiao'){
            this.ruleForm.tijianbiao = obj[o];
	    this.ro.tijianbiao = true;
            continue;
          }
          if(o=='xueshengchengjibiao'){
            this.ruleForm.xueshengchengjibiao = obj[o];
	    this.ro.xueshengchengjibiao = true;
            continue;
          }
          if(o=='dangjiguanxi'){
            this.ruleForm.dangjiguanxi = obj[o];
	    this.ro.dangjiguanxi = true;
            continue;
          }
          if(o=='rongyuzhengshu'){
            this.ruleForm.rongyuzhengshu = obj[o];
	    this.ro.rongyuzhengshu = true;
            continue;
          }
          if(o=='zhaopian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xuejixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuejixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    tijianbiaoUploadChange(fileUrls) {
	this.ruleForm.tijianbiao = fileUrls;
			this.addEditUploadStyleChange()
    },
    xueshengchengjibiaoUploadChange(fileUrls) {
	this.ruleForm.xueshengchengjibiao = fileUrls;
			this.addEditUploadStyleChange()
    },
    rongyuzhengshuUploadChange(fileUrls) {
	this.ruleForm.rongyuzhengshu = fileUrls;
			this.addEditUploadStyleChange()
    },
