 ...
 */
@RestController
@RequestMapping("/ruxuebanli")
public class RuxuebanliController {
    @Autowired
    private RuxuebanliService ruxuebanliService;
    ...
    public R delete(@RequestBody Long[] ids){
        ruxuebanliService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<RuxuebanliEntity> wrapper = new EntityWrapper<RuxuebanliEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = ruxuebanliService.selectCount(wrapper);
